...
function adjustDifficulty(runTime) {
    ...
    if (runTime > 10000 && runTime <= 20000) { return START_SPEED - SPEED_DECREMENT } else if (runTime > 20000 && runTime <= 30000) { return START_SPEED - 2 * SPEED_DECREMENT } else if (runTime > 30000 && runTime <= 40000) { return START_SPEED - 3 * SPEED_DECREMENT } else if (runTime > 40000 && runTime <= 50000) { return START_SPEED - 4 * SPEED_DECREMENT } else if (runTime > 50000 && runTime <= 60000) { return START_SPEED - 5 * SPEED_DECREMENT } else if (runTime > 60000 && runTime <= 70000) { return START_SPEED - 6 * SPEED_DECREMENT } else if (runTime > 70000 && runTime <= 80000) { return START_SPEED - 7 * SPEED_DECREMENT } else if (runTime > 80000 && runTime <= 100000) { return START_SPEED - 8 * SPEED_DECREMENT } else if (runTime > 100000 && runTime <= 110000) { return START_SPEED - 9 * SPEED_DECREMENT } else if (runTime >= 110000) { return difficulty }
}
